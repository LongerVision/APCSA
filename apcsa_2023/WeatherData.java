...
public class WeatherData {
    ...
    public static void main(String[] args) {
        // double[] dArr = { 99.1, 142.0, 85.0, 85.1, 84.6, 94.3, 124.9, 98.0, 101.0,
        // 102.5 };
        double[] dArr = { 100.5, 98.5, 102.0, 103.9, 87.5, 105.2, 90.3, 94.88, 109.1, 102.1, 107.4, 93.2 };
        WeatherData wd = new WeatherData(dArr);
        // wd.cleanData(85.0, 120.0);

        System.out.println(wd.longestHeatWave(95.2));
    }
}